...
mongoose.connect('mongodb://localhost:27017/Chat', { useFindAndModify: false, useCreateIndex: false });
    ...
    socket.on('send_message', (data) => {
      console.log(data.name + ": " + data.message)
        ...
        const postData = async () => {
          const messenger = await Messenger.findOne({id_user1: newData.id_user1, id_user2: newData.id_user2})
